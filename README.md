...
| 3.5 | Сервис уведомлений | `services.py` | Эмуляция отправки уведомлений в консоль |
| 3.6 | Учётная система (Ledger) | `services.py` | Сохранение транзакций в SQLite |
| 3.7 | CRM-сервис | `services.py` | Агрегация сумм за 5 минут, повышение статуса |
