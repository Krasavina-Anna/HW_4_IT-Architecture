...
| 3.5 | Сервис уведомлений | `3_5_and_3_6_and_3_7.py` | Эмуляция отправки уведомлений в консоль |
| 3.6 | Учётная система (Ledger) | `3_5_and_3_6_and_3_7.py` | Сохранение транзакций в SQLite |
| 3.7 | CRM-сервис | `3_5_and_3_6_and_3_7.py` | Агрегация сумм за 5 минут, повышение статуса |
| 4 | Request‐reply | `Add_point.ipynb` | Возврат клиенту актуального статуса |
